...
printf("los numeros ingresados son: %ls \n",numeros);
}
...
int i=0;
 ...
 for(i=0; i<strlen(datos);i++){               //Este ciclo se utiliza para recorrer el array datos y comparar posición a poscicion con el array nuevo.
                if (datos[i]<datos1[i]){
                printf("en la posicion %d, el arreglo 1 es menor que el arreglo 2 \n", i);
                        }
                else if(datos1[i]<datos[i]){
                printf("en la posicion %d, el arreglo 1 es mayor que el arreglo 2 \n",i);

                        }
                else{
                printf("en la posicion %d, el arreglo 1 es igual al arreglo 2 \n",i);
                        }
                }
 	...
 	printf("los arrays son iguales \n");
        ...
        printf("el arrays 1 es menor que el array 2 \n");
        }
        else {
        printf("el array 1 es mayor que el array 2 \n");
        }
